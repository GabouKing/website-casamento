    ...
    <div className={`flex flex-1 flex-col items-center p-16 m-2 bg-white-100 w-80 max-h-[450px] rounded-3xl ${data.comprado ? 'opacity-50 pointer-events-none' : ''}`}>
      ...
      {(modalAberto && data.id != 100) && (      
        <div className="fixed top-0 left-0 w-screen h-screen flex items-center justify-center bg-gray-800 bg-opacity-75 z-50">
          <div className='bg-white-100 p-4 rounded-lg text-center flex flex-col'>
            <div className='flex flex-col'>
            <p className='font-sans'>Dedicatoria</p>
            <input className='font-sans border-b border-gray-100 py-1 mb-1' type="text" placeholder='Nome' 
              value={nome}
              onChange={handleNomeChange}/>
            <input className='font-sans border-b border-gray-100 py-1 mb-1' type="text" placeholder='Dedicatoria'
              value={dedicatoria}
